...
public class InterpreterTest {
    ...
    public void testBoolDataSet() {
        ...
        Expression exp0 = ExpressionFactory.createBinaryOperator(OperatorType.AND, ColumnType.BOOLEAN, ref0, ref1);
        Expression exp1 = ExpressionFactory.createBinaryOperator(OperatorType.OR, ColumnType.BOOLEAN, ref0, ref1);
        Expression exp2 = ExpressionFactory.createUnaryOperator(OperatorType.NOT, ColumnType.BOOLEAN, ref0);
    ...
    public void testTypeDataSet() {
        ...
        Expression cmp0 = ExpressionFactory.createBinaryOperator(OperatorType.LE, ColumnType.BOOLEAN, ref0, c0);
        Expression cmp1 = ExpressionFactory.createBinaryOperator(OperatorType.LT, ColumnType.BOOLEAN, ref1, c1);
        Expression cmp2 = ExpressionFactory.createBinaryOperator(OperatorType.NE, ColumnType.BOOLEAN, ref2, c2);
        Expression cmp3 = ExpressionFactory.createBinaryOperator(OperatorType.EQ, ColumnType.BOOLEAN, ref3, c3);
    ...
    public void testMapperDataSet() {
        ...
        Expression notNull = ExpressionFactory.createUnaryOperator(OperatorType.AS, ColumnType.INT, ref0);
        notNull = ExpressionFactory.createUnaryOperator(OperatorType.IS_NOT_NULL, ColumnType.BOOLEAN, ref0);
        Expression isNull = ExpressionFactory.createUnaryOperator(OperatorType.IS_NULL, ColumnType.BOOLEAN, ref1);
    ...
    public void testOperatorDataSet() {
        ...
        Expression exp0 = ExpressionFactory.createBinaryOperator(OperatorType.TIMES, ColumnType.INT, ref0, c0);
        ...
        Expression tmp0 = ExpressionFactory.createBinaryOperator(OperatorType.MOD, ColumnType.INT, exp0, exp0);
        exp0 = ExpressionFactory.createBinaryOperator(OperatorType.PLUS, ColumnType.INT, exp0, tmp0);

        Expression exp1 = ExpressionFactory.createBinaryOperator(OperatorType.TIMES, ColumnType.DOUBLE, ref1, c1);
        ...
        Expression tmp1 = ExpressionFactory.createBinaryOperator(OperatorType.MOD, ColumnType.DOUBLE, exp1, exp1);
        exp1 = ExpressionFactory.createBinaryOperator(OperatorType.PLUS, ColumnType.DOUBLE, exp1, tmp1);

        Expression exp2 = ExpressionFactory.createBinaryOperator(OperatorType.TIMES, ColumnType.FLOAT, ref2, c2);
        ...
        Expression tmp2 = ExpressionFactory.createBinaryOperator(OperatorType.MOD, ColumnType.FLOAT, exp2, exp2);
        exp2 = ExpressionFactory.createBinaryOperator(OperatorType.PLUS, ColumnType.FLOAT, exp2, tmp2);

        Expression exp3 = ExpressionFactory.createBinaryOperator(OperatorType.TIMES, ColumnType.LONG, ref3, c3);
        ...
        Expression tmp3 = ExpressionFactory.createBinaryOperator(OperatorType.MOD, ColumnType.LONG, exp3, exp3);
    ...
    public void testAggregate() {
        ...
        DataSet aggDataSet2 = Interpreter.aggregate(dataset, ImmutableList.of(), new ArrayList<Expression>());
