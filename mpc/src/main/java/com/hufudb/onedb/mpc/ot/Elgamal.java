...
public class Elgamal {
  ...
  private static void initFromPG() {
    p = new BigInteger(P);
    g = new BigInteger(G);
    LOG.debug("generate p, g successfully");
  }

  public static void setPG() {
    if (p == null) {
      synchronized (Elgamal.class) {
        if (p == null) {
          //init() is very slow
          initFromPG();
        }
  ...
  public static void setPG(byte[] pByteArray, byte[] gByteArray) {
    if (p == null) {
      synchronized (Elgamal.class) {
        if (p == null) {
          p = new BigInteger(pByteArray);
          g = new BigInteger(gByteArray);
        }
      }
    }
  }

  public static byte[] generatePseudoPublicKey() {
    assert p != null;
  ...
  public Elgamal(byte[] hByteArray) {
    h = new BigInteger(hByteArray);
    x = null;
  }
  ...
  public static byte[] getPByteArray() {
    return p.toByteArray();
  }

  public static byte[] getGByteArray() {
