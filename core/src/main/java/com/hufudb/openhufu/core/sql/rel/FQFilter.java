...
public class FQFilter extends Filter implements FQRel {
  public FQFilter(RelOptCluster cluster, RelTraitSet traitSet, RelNode child,
      RexNode condition) {
  ...
  public Filter copy(RelTraitSet traitSet, RelNode input, RexNode condition) {
    return new FQFilter(getCluster(), traitSet, input, condition);
  }
}
