...
public interface OpenHuFuRel extends RelNode {
  Convention CONVENTION = new Convention.Impl("OpenHuFu", OpenHuFuRel.class);
  ...
  class Implementor {
    ...
    OpenHuFuSchemaManager schemaManager;
    RootPlan rootPlan;
    Plan currentPlan;
    ...
    public void visitChild(OpenHuFuRel input) {
      input.implement(this);
    }

    public void setSchemaManager(OpenHuFuSchemaManager schemaManager) {
