...
public class OpenHuFuZkClient extends ZkClient {

  private final OpenHuFuSchemaManager manager;
  private final String schemaDirectoryPath;

  public OpenHuFuZkClient(ZkConfig zkConfig, OpenHuFuSchemaManager manager) {
  ...
  public void watchGlobalTable(String tableName) throws KeeperException, InterruptedException {
    ...
    Table table = OpenHuFuTable.create(manager, tableMeta);
    if (table != null) {
