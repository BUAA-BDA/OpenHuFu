...
public class OpenHuFuTableSchema {
  private static final Logger LOG = LoggerFactory.getLogger(OpenHuFuTableSchema.class);
  ...
  public OpenHuFuTableSchema(String name, Schema schema) {
    this.name = name;
    this.schema = schema;
  ...
  public OpenHuFuTableSchema(String globalName, Schema schema, OwnerClient client, String localName) {
