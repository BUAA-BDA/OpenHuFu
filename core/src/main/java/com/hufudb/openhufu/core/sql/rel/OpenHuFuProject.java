...
public class OpenHuFuProject extends Project implements OpenHuFuRel {
  public OpenHuFuProject(RelOptCluster cluster, RelTraitSet traitSet, RelNode input,
  ...
  public Project copy(RelTraitSet traitSet, RelNode input, List<RexNode> projects,
      RelDataType rowType) {
    return new OpenHuFuProject(getCluster(), traitSet, input, projects, rowType);
  }
