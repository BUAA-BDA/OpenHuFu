...
public class FQTableSchema {
  private static final Logger LOG = LoggerFactory.getLogger(FQTableSchema.class);
  ...
  public FQTableSchema(String name, Schema schema) {
    this.name = name;
    this.schema = schema;
  ...
  public FQTableSchema(String globalName, Schema schema, OwnerClient client, String localName) {
