...
public class OpenHuFuAggregate extends Aggregate implements OpenHuFuRel {
  public OpenHuFuAggregate(RelOptCluster cluster, RelTraitSet traitSet, RelNode input,
  ...
  public Aggregate copy(RelTraitSet traitSet, RelNode input, ImmutableBitSet groupSet,
    ...
    return new OpenHuFuAggregate(getCluster(), traitSet, input, groupSet, groupSets, aggCalls);
  }
}
