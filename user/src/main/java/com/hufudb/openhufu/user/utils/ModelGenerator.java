...
import com.hufudb.openhufu.core.table.utils.PojoOwnerInfo;

public class ModelGenerator {
  private static String modelTemplate = "inline:"
  + "{\n"
  + "  'version': '1.0',\n"
  + "  'defaultSchema': 'openhufu',\n"
  + "  'schemas': [\n"
  + "    {\n"
  + "      'type': 'custom',\n"
  + "      'name': 'openhufu',\n"
  + "      'factory': 'com.hufudb.openhufu.core.sql.schema.OpenHuFuSchemaFactory',\n"
  + "      'operand': {\n"
  + "        'owners': [\n%s\n]\n"
  + "      },\n"
  + "      'tables': [\n%s\n]\n"
  ...
  + "  'name': '%s',\n"
  + "  'factory': 'com.hufudb.openhufu.core.table.OpenHuFuTableFactory',\n"
  + "  'operand': {\n"
  + "    'components': [\n%s\n]\n"
  + "  }\n"
  + "}";
